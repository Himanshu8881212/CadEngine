...
analysis layer on top, and one JSON op surface (162 ops) over all of it — because it is
...
surface describes itself — `{"op": "describe"}` enumerates all 162 ops and
...
see [`docs/OP_USAGE.md`](docs/OP_USAGE.md) for the census (161 dispatched on the census date, 84 used).
