	...
	match kind {
		...
		OpKind::Iso286Fit { d, fit } => {
			let f = parts::iso286_fit(d, &fit).ok_or_else(|| {
				err(
					ErrorKind::InvalidParam,
					format!("op '{op_id}': iso286_fit: '{fit}' at Ø{d} — supported fits are H11/c11, H9/d9, H8/f7, H7/g6, H7/h6, H7/k6, H7/n6, H7/p6, H7/s6 (hole basis), C11/h11, D9/h9, F8/h7, G7/h6 (shaft basis), H6/j5, H6/k5, H7/j6 (bearing-seat shafts), K7/h6, N7/h6, P7/h6 (bearing housings; ISO 286-1 §4.3 Δ rule) at 0 < d ≤ 120 mm"),
				)
			})?;
