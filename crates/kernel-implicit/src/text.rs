...
fn glyph(c: char) -> Option<Glyph> {
	Some(match c {
		...
		'P' => {
			(21, &[&[(4, 21), (4, 0)], &[(4, 21), (13, 21), (16, 20), (17, 19), (18, 17), (18, 14), (17, 12), (16, 11), (13, 10), (4, 10)]])
		}
		'Q' => (
			22,
			&[
...
impl TextSdf {
	...
	pub fn new(text: &str, height: f32, stroke_radius: f32) -> Self {
		...
		assert!(stroke_radius.is_finite() && stroke_radius > 0.0, "TextSdf: stroke_radius must be finite and > 0, got {stroke_radius}");
		...
		assert!(!segs.is_empty(), "TextSdf: {text:?} produced no strokes — text needs at least one non-space glyph");
