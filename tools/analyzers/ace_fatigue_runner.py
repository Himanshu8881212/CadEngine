...
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))  # tools/: the shared contracts + the layout map
...
FATIGUE_DB = TOOLS_DIR.parent / "materials" / "fatigue.json"  # tools/materials/ (DATA stays at the top level)
