...
- **Runner**: `tools/ace_fatigue_runner.py` · **Gates**: `tools/test_ace_contact_fatigue.py` · **Data**: `tools/materials/fatigue.json` (this solver's own researched registry; it never edits the material records) · in-house (NumPy only)
...
Run: `python3 tools/ace_fatigue_runner.py job.json` · prove: `python3 tools/test_ace_contact_fatigue.py`
