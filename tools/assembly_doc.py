#!/usr/bin/env python3
# LMCAD forwarding shim — assembly_doc.py moved to tools/publish/assembly_doc.py on 2026-09-02 (the
...
# `python3 tools/assembly_doc.py job.json` keeps working for every campaign run_all.sh
# and CI job; imported as a module it hands back the real module.
# Edit the real file, never this one.
import os
import sys

_target = os.path.join(os.path.dirname(os.path.abspath(__file__)), "publish", "assembly_doc.py")
