...
CONTACT = Path(os.environ.get("ACE_CONTACT_RUNNER", _layout.find_tool("ace_contact_runner.py")))
FATIGUE = Path(os.environ.get("ACE_FATIGUE_RUNNER", _layout.find_tool("ace_fatigue_runner.py")))
